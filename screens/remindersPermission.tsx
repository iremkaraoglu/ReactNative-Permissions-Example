...
export default function ReminderPermissionScreen() {
  ...
  React.useEffect(() => {
    request(PERMISSIONS.IOS.REMINDERS).then((result) => {
    ...
    <>
      ...
      <SafeAreaView style={styles.root}>
        <ScrollView style={styles.container}>
          <Text style={styles.title}>Reminders Permission Needed</Text>
          <Text style={styles.description}>
            This app needs access to your reminders. If you are not comfortable
